export const SKILL_ID = 'archipam';
export const EXPECTED_REPOSITORY = 'https://github.com/licpmb/Archi';
export const DEFAULT_MANIFEST_URL = 'https://licpmb.github.io/Archi/skill-updates/archipam/stable.json';
...
export function validateReleaseNotesUrl(value, version) {
  ...
  const expected = `https://github.com/licpmb/Archi/releases/tag/v${version}`;
  if (value !== expected) {
